CREATE OR REPLACE SCHEMA deposit_wallet_arb; 
USE SCHEMA deposit_wallet_arb; 
CREATE OR REPLACE TABLE arb_addr_labels LIKE bronze.prod_address_label_sink_291098491;  
CREATE OR REPLACE TABLE arb_address_labels_staging (
...
INSERT INTO arb_address_labels_staging (
  ...
  possible_sats AS (
    ...
    from (
      ...
      FROM arbitrum.core.fact_token_transfers xfer
      ...
      FROM arbitrum.core.fact_traces tr
...
DELETE FROM arb_address_labels_staging l  
...
SELECT * FROM deposit_wallet_arb.arb_address_labels_staging