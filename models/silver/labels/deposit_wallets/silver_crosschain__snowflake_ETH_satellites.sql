CREATE OR REPLACE SCHEMA deposit_wallet_eth; 
USE SCHEMA deposit_wallet_eth; 
CREATE OR REPLACE TABLE eth_addr_labels LIKE bronze.prod_address_label_sink_291098491;  
CREATE OR REPLACE TABLE eth_address_labels_staging (
...
INSERT INTO eth_address_labels_staging (
...
DELETE FROM eth_address_labels_staging l  
...
SELECT * FROM deposit_wallet_eth.eth_address_labels_staging