CREATE OR REPLACE SCHEMA deposit_wallet_avax; 
USE SCHEMA deposit_wallet_avax; 
CREATE OR REPLACE TABLE avax_addr_labels LIKE bronze.prod_address_label_sink_291098491;  
CREATE OR REPLACE TABLE avax_address_labels_staging (
...
INSERT INTO avax_address_labels_staging (
  ...
  possible_sats AS (
    ...
    from (
      ...
      FROM avalanche.core.fact_token_transfers xfer
      ...
      FROM avalanche.core.fact_traces tr
...
DELETE FROM avax_address_labels_staging l  
...
SELECT * FROM deposit_wallet_avax.avax_address_labels_staging