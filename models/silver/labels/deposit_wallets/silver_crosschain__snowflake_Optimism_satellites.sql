CREATE OR REPLACE SCHEMA deposit_wallet_opt; 
USE SCHEMA deposit_wallet_opt; 
CREATE OR REPLACE TABLE opt_addr_labels LIKE bronze.prod_address_label_sink_291098491;  
CREATE OR REPLACE TABLE opt_address_labels_staging (
...
INSERT INTO opt_address_labels_staging (
  ...
  possible_sats AS (
    ...
    from (
      ...
      FROM optimism.core.fact_token_transfers xfer
...
DELETE FROM opt_address_labels_staging l  
...
SELECT * FROM deposit_wallet_opt.opt_address_labels_staging