{{ config(
    ...
    post_hook = "ALTER TABLE {{ this }} ADD SEARCH OPTIMIZATION ON EQUALITY(tx_hash, contract_address, token_address, token_symbol, depositor, protocol_market), SUBSTRING(token_address, token_symbol, depositor, protocol_market)",
    tags = ['hourly']
) }}
